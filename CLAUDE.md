...
src/app/                    routes
  ...
  holders/page.tsx          one page, one table (since 2026-09-13): the reward-coin census headline (§6g: wallets holding a reward coin,
                            category tiles), the stock-token census block (§6f: unique wallets holding any stock quote asset, issuer
