...
import { BuybackCard, BUYBACK_CARD_SIZE } from "@/lib/buyback-card";
...
// GET /buyback-card?hours=1 → 1600×900 PNG: the top 10 quote coins by USD spent buying $STONK over
...
export async function GET(req: Request) {
  ...
  const [board, burns] = await Promise.all([getBuybackLeaderboard(hours, 10), getTokenBurns(STONK_MINT).catch(() => null)]);
