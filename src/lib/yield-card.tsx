...
// Ranks the /yield table by APR over `window`, keeping only rows that have that window. Shared by the
  ...
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", background: C.bg, color: C.ink, fontFamily: "Geist", padding: "0 72px" }}>
      ...
      <div style={{ display: "flex", flex: 1, gap: 64 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", width: 520, padding: "44px 0 28px", borderRight: `1px solid ${C.line}`, paddingRight: 56 }}>
          <div style={{ display: "flex", flexDirection: "column", fontSize: 64, fontWeight: 600, letterSpacing: -2.5, lineHeight: 1.02 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 40, marginTop: "auto" }}>
            {kpi("TOP APR", pct(rows[0]?.apr ?? 0), "realized")}
